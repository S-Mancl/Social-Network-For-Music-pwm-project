            ...
            if(err){
               ...
               */
                ...
                switch (req.body.operation) {
                    ...
                    case "delete":
                        //elimino un gruppo
                        let a = await pwmClient.db("pwm_project").collection('groups').findOne({"name": validator.escape(req.body.name)})
