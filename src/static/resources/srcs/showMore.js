...
.then(response => {
    ...
    try{
        ...
        <div class="row g-4 mt-4 p-4 d-flex justify-content-center">
            ...
            <div class="card-footer"><p class="card-text"><small class="text-body-secondary"></small></p><a href="#" class="btn btn-secondary testo-pulsante text-btn-this">View more</a></div></div></div></div>`
