                    ...
                    fetch('/genres')
                        ...
                        .then((response) => {
                            response.results.forEach(element => {
                                toFill.innerHTML+=`<div class="form-check col-6 col-sm-3 col-md-2 form-check-inline"><input class="form-check-input" type="checkbox" value="${element}" id="${element}" ${userData.favoriteGenres.some(favorite => favorite == element)?"checked":""}> <label class="form-check-label normal-text" for="${element}">${element}</label></div>`
                            });
                        })
                })
        }
