...
function duration(ms){
    return `${Math.floor(ms/1000/60)}:${Math.floor(ms/1000)-Math.floor(ms/1000/60)*60}`
}
function alarm(where,good,reason){
    document.getElementById(where).innerHTML=`<div class="position-fixed bottom-0 end-0 p-3 scale-text" style="z-index: 11">
